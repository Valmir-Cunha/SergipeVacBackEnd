...
namespace SergipeVac.Migrations
{
    ...
    [Migration("20230814022650_AdicionadoTabelaParaSalvarRegistrosDeSincronizacao")]
    partial class AdicionadoTabelaParaSalvarRegistrosDeSincronizacao
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SergipeVac.Model.ModeloDados.Categoria", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SergipeVac.Model.ModeloDados.DocumentoImportado", b =>
                {
                    ...
                    b.ToTable("DocumentoImportadoCSV");
                });

            modelBuilder.Entity("SergipeVac.Model.ModeloDados.DocumentoVacinacao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SergipeVac.Model.ModeloDados.Endereco", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SergipeVac.Model.ModeloDados.Estabelecimento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SergipeVac.Model.ModeloDados.Fabricante", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SergipeVac.Model.ModeloDados.GrupoAtendimento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SergipeVac.Model.ModeloDados.Municipio", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SergipeVac.Model.ModeloDados.Nacionalidade", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SergipeVac.Model.ModeloDados.Paciente", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SergipeVac.Model.ModeloDados.Pais", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SergipeVac.Model.ModeloDados.Raca", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SergipeVac.Model.ModeloDados.SexoBiologico", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SergipeVac.Model.ModeloDados.Sistema", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SergipeVac.Model.Sincronizacao.DadosSincronizacao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("QuantidadeRegistrosAdicionados")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("DadosSincronizacao");
                });

            modelBuilder.Entity("SergipeVac.Model.ModeloDados.DocumentoVacinacao", b =>
                {
                    b.HasOne("SergipeVac.Model.ModeloDados.Categoria", "Categoria")
                        .WithMany()
                        .HasForeignKey("CategoriaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SergipeVac.Model.ModeloDados.Estabelecimento", "Estabelecimento")
                        .WithMany()
                        .HasForeignKey("EstabelecimentoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SergipeVac.Model.ModeloDados.Fabricante", "Fabricante")
                        .WithMany()
                        .HasForeignKey("FabricanteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SergipeVac.Model.ModeloDados.GrupoAtendimento", "GrupoAtendimento")
                        .WithMany()
                        .HasForeignKey("GrupoAtendimentoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SergipeVac.Model.ModeloDados.Paciente", "Paciente")
                        .WithMany()
                        .HasForeignKey("PacienteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SergipeVac.Model.ModeloDados.Sistema", "SistemaOrigem")
                        .WithMany()
            ...
            modelBuilder.Entity("SergipeVac.Model.ModeloDados.Endereco", b =>
                {
                    b.HasOne("SergipeVac.Model.ModeloDados.Municipio", "Municipio")
                        .WithMany()
            ...
            modelBuilder.Entity("SergipeVac.Model.ModeloDados.Municipio", b =>
                {
                    b.HasOne("SergipeVac.Model.ModeloDados.Pais", "Pais")
                        .WithMany()
            ...
            modelBuilder.Entity("SergipeVac.Model.ModeloDados.Paciente", b =>
                {
                    b.HasOne("SergipeVac.Model.ModeloDados.Endereco", "Endereco")
                        .WithMany()
                        .HasForeignKey("EnderecoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SergipeVac.Model.ModeloDados.Nacionalidade", "Nacionalidade")
                        .WithMany()
                        .HasForeignKey("NacionalidadeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SergipeVac.Model.ModeloDados.Raca", "Raca")
                        .WithMany()
                        .HasForeignKey("RacaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SergipeVac.Model.ModeloDados.SexoBiologico", "SexoBiologico")
                        .WithMany()
